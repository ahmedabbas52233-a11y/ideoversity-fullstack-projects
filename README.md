...
A collection of 12 front-end projects built during my full-stack development course at **Ideoversity**. Each project demonstrates practical skills in HTML, CSS, and JavaScript — from responsive layouts and UI cloning to interactive logic, animations, and accessibility compliance.
...
Built during the Ideoversity Full-Stack Development Course.

- 🎓 Course: Ideoversity Full-Stack Program (2026)
- 💻 Focus: HTML, CSS, JavaScript fundamentals
- 🔧 Debugging: Microsoft Edge Tools, axe accessibility auditor
...
| #   | Project                         | What It Demonstrates            | Key Features                                                                                       |
| --- | ------------------------------- | ------------------------------- | -------------------------------------------------------------------------------------------------- |
| 1   | **Baroque Fashion Landing**     | Luxury e-commerce homepage      | Sticky header, hover animations, newsletter popup with `localStorage`, responsive breakpoints      |
| 2   | **Calculator**                  | JavaScript logic & precision    | Keyboard support, operation chaining, divide-by-zero guard, floating-point fix (`0.1 + 0.2 = 0.3`) |
| 3   | **ChatBot**                     | DOM manipulation & layout       | Dual-panel chat, proper message alignment (sender vs receiver), auto-scroll                        |
| 4   | **Analog-Digital Clock**        | Real-time JS & CSS transforms   | Millisecond-precision analog hands, blinking colon, full date formatting                           |
| 5   | **Education Website**           | Classic 3-column layout         | Warm palette, newsletter form, responsive media queries                                            |
| 6   | **Facebook Signup Clone**       | Pixel-perfect UI replication    | Form validation, accessible dropdowns, exact color matching                                        |
| 7   | **Photo Frame**                 | CSS box-shadow artistry         | Layered inset shadows, aspect-ratio control, placeholder integration                               |
| 8   | **GCU Lahore Portal**           | Institutional website structure | Contact form, location info, classic academic aesthetic                                            |
| 9   | **Invoice Template**            | Print-ready document design     | Table-based layout, `@media print` styles, professional typography                                 |
| 10  | **Junaid Jamshed Product Page** | Complex e-commerce patterns     | Image zoom lens, thumbnail gallery, accordion, size selector, quantity controls                    |
| 11  | **Sky Day-to-Night**            | CSS animations & atmosphere     | Randomized star generation, smooth gradient transitions, interactive slider                        |
| 12  | **Tic-Tac-Toe**                 | Game logic & state management   | Win detection (8 combinations), draw handling, score tracking, winning line highlight              |

---

## 🏆 Ranked by Portfolio Value

1. **J. Product Page** — Most complex, real-world e-commerce patterns
2. **Calculator** — Solid logic + keyboard accessibility + precision math
3. **Sky Day-to-Night** — Creative, shows CSS animation skill
4. **Analog-Digital Clock** — Clean, functional, good use of JS + CSS
5. **Tic-Tac-Toe** — Classic algorithm exercise with visual feedback
6. **Baroque** — Good landing page structure with UX considerations
7. **Invoice Template** — Clean professional document template
8. **Facebook Signup Clone** — Good clone, demonstrates attention to detail
9. **ChatBot** — Basic but functional DOM practice
...
git clone https://github.com/yourusername/ideoversity-fullstack-projects.git
