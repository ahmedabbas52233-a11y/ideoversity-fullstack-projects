function addMsg(name, text, colorClass) {
    ...
    document.getElementById('area-ahmad').scrollTop = document.getElementById('area-ahmad').scrollHeight;
    document.getElementById('area-ali').scrollTop = document.getElementById('area-ali').scrollHeight;
}
